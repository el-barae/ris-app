-- ========================================
-- Diagnostic complet de l'erreur hospital_id dans exams (UTF-8)
-- ========================================

-- 1. Verifier si la colonne hospital_id existe dans exams
DO $$
DECLARE
...
-- 3. Verifier les ordres liés aux examens sans hôpital
SELECT 
